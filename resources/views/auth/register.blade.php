                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="no_sim" class="col-md-4 col-form-label text-md-right">{{ __('No SIM') }}</label>
                                <div class="col-md-6">
                                    <input id="no_sim" type="text" class="form-control" name="no_sim" value="{{ old('no_sim') }}" required>
                                </div>
                            </div>
